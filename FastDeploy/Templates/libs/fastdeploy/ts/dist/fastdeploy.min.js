...
/* harmony export */   "initImagePicker": () => (/* binding */ initImagePicker)
/* harmony export */ });
...
/* harmony import */ var _fd_file_picker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fd-file-picker */ "./src/controls/fd-file-picker.ts");
...
function initImagePicker(container) {
    let picker = new _fd_file_picker__WEBPACK_IMPORTED_MODULE_3__.FastDeployImagePicker();
...
/***/ "./src/controls/fd-file-picker.ts":
/*!****************************************!*\
  !*** ./src/controls/fd-file-picker.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FastDeployFilePicker": () => (/* binding */ FastDeployFilePicker),
/* harmony export */   "FastDeployImagePicker": () => (/* binding */ FastDeployImagePicker)
/* harmony export */ });
class FastDeployFilePicker {
    init(container) {
    }
}
class FastDeployImagePicker {
    init(container) {
        container.find('.img-preview').on('click', imagePreviewOnClick);
        container.find('.file-upload').on('change', imagePickerFileChanged);
    }
}
function imagePreviewOnClick(e) {
    e.stopPropagation();
    let el = $(e.currentTarget), container = el.parents('.upload-container');
    container.find('.file-upload').trigger('click');
}
function imagePickerFileChanged(e) {
    e.stopPropagation();
    let el = e.currentTarget;
...
function imagePicker(container) {
    (0,_controls_fd_controls__WEBPACK_IMPORTED_MODULE_1__.initImagePicker)(container);
}
