<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucMenuDetail.ascx.cs" Inherits="AdminSite.UserControls.ucMenuDetail" %>
<%@ Register Src="~/UserControls/ucAddSubMenu.ascx" TagPrefix="uc1" TagName="ucAddSubMenu" %>


<div class="panel-heading panel-heading-custom">
    <label id="lbHeader" runat="server">Thông Tin Danh Mục</label>
</div>
    ...
    <div class="tab-content">
        ...
        <div class="form-horizontal">
            <div id="formSubMenu" runat="server" class="form-group">
                <label class="control-label col-lg-2">Danh mục con:</label>
                <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="button" id="btnDeleteSubMenu" class="btn btn-danger btn-danger-custom" value="x" onclick="startDeleteSubMenu()" />
                </div>
            </div>
            <div class="form-group">
