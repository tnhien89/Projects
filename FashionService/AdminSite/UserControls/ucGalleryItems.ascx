<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucGalleryItems.ascx.cs" Inherits="AdminSite.UserControls.ucGalleryItems" %>

<div class="panel-heading panel-heading-custom">
        <label id="lbHeader" runat="server">Thư Viện Hình</label>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <asp:GridView ID="grvProjectItems" runat="server" GridLines="none" CssClass="gridview-custom" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="true" PageSize="20" ClientIDMode="Static" OnPageIndexChanging="grvProjectItems_PageIndexChanging" OnSorting="grvProjectItems_Sorting" OnRowDataBound="grvProjectItems_RowDataBound">
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="Name_VN" HeaderText="Tên" SortExpression="Name_VN" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="{0}"/>
